			...
			<div class="modal-body">
				<form id="form-keluarga">
					...
					<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
						<li class="nav-item">
							<a class="nav-link active" id="pills-pengenalan-tempat-tab" data-toggle="pill" href="#pills-pengenalan-tempat" role="tab" aria-controls="pills-identity" aria-selected="true">Pengenalan Tempat</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" id="pills-keterangan-perumahan-tab" data-toggle="pill" href="#pills-keterangan-perumahan" role="tab" aria-controls="pills-keterangan-perumahan" aria-selected="false">Keterangan Perumahan</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" id="pills-aset-program-tab" data-toggle="pill" href="#pills-aset-program" role="tab" aria-controls="pills-aset-program" aria-selected="false">Aset & Program</a>
						</li>
					</ul>

					<div class="tab-content" id="pills-tabContent">
						<div class="tab-pane fade show active" id="pills-pengenalan-tempat" role="tabpanel" aria-labelledby="pills-pengenalan-tempat-tab">
						...
						<div class="tab-pane fade show" id="pills-keterangan-perumahan" role="tabpanel" aria-labelledby="pills-keterangan-perumahan-tab">
						...
						<div class="tab-pane fade show" id="pills-aset-program" role="tabpanel" aria-labelledby="pills-aset-program-tab">
							<div class="box box-primary">
								<!-- <div class="box-header with-border">
