...
<ul class="sidebar navbar-nav" style="background-color: #32405a; padding-top: 30px;" >
    ...
    <!-- Dashboard --> <li class="nav-item <?php echo $this->uri->segment(2) == '' ? 'active' : '' ?>"> 
    ...
    <!-- Data --> <li class="nav-item dropdown <?php echo $this->uri->segment(2) == 'alternatif' || $this->uri->segment(2) == 'bobot' ? 'active show' : '' ?>"> 
    ...
    <!-- Perhitungan --><li class="nav-item dropdown <?php echo $this->uri->segment(2) == 'promethee' || $this->uri->segment(2) == 'wp' || $this->uri->segment(2) == 'saw' || $this->uri->segment(2) == 'copeland' ? 'active show' : '' ?>">
    ...
    <!-- Voting --><li class="nav-item dropdown <?php echo $this->uri->segment(2) == 'vote' || $this->uri->segment(2) == 'proses' || $this->uri->segment(2) == 'hasilvote' ? 'active show' : '' ?>">
        <a class="nav-link dropdown-toggle" href="#" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    ...
    <!-- Akurasi --> <li class="nav-item <?php echo $this->uri->segment(3) == 'akurasi' ? 'active' : '' ?>">
        <a class="nav-link" href="<?php echo site_url('admin/akurasi') ?>">
            <i class="fa fa-fw fa-tasks"></i>
            <span> Akurasi</span></a>
    </li>
    <!-- Manajemen User --><li class="nav-item">
